        ...
        StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    _buildStatCard("Meals\nRescued", totalMeals.toString(), Icons.restaurant, Colors.orange.shade700),

                    // REPLACED CO2 WITH TANGIBLE MONEY SAVED
                    _buildStatCard("Food Worth\nSaved", "₹$foodValue", Icons.currency_rupee, Colors.green.shade700),

                    _buildStatCard("Successful\nDeliveries", totalTrips.toString(), Icons.local_shipping, Colors.blue.shade700),
                  ],
                ),
              );
            }
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text("Complete a delivery to see your impact!", style: TextStyle(color: Colors.grey)),
                    ],
                  ),
                );
              }
                        ...
                        children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text("Verified Delivery", style: TextStyle(color: Colors.green.shade800, fontSize: 10, fontWeight: FontWeight.bold)),
                                  ],
                                ),
                              )
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Text("${data['quantity']} Meals Saved", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Container(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const Text("Delivered to:", style: TextStyle(fontSize: 11, color: Colors.grey)),
                                      Text(data['selectedNgoName'] ?? 'NGO Hub', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                                    ],
                                  ),
                                ),
                              ],
