...
class _CountdownTimerWidgetState extends State<CountdownTimerWidget> {
  ...
  void _updateTime() {
    if (widget.expiryTimestamp == null) {
      setState(() => timeLeft = "No exact expiry set");
      return;
    }
...
class _DonorHomeTabState extends State<DonorHomeTab> {
  ...
  void _attemptPostFood() {
    bool isProfileComplete = widget.userData.containsKey('contact') && widget.userData['contact'].toString().isNotEmpty &&
        ...
        widget.userData.containsKey('streetName') && widget.userData['streetName'].toString().isNotEmpty;
    ...
    if (!isProfileComplete) {
      showDialog(
          ...
          builder: (context) => AlertDialog(
              ...
              content: const Text("You must complete your profile details (Phone Number, Building Name, and Street) in the Profile tab before posting food rescues. This ensures volunteers can find you."),
              actions: [
                TextButton(
                    onPressed: () => Navigator.pop(context),
                    child: const Text("OK, I'll update it", style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold))
                )
              ]
          )
      );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(label: _requiredLabel("Food Details (e.g., 50 Rotis)"), border: const OutlineInputBorder()),
                        ),
                        const SizedBox(height: 15),
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(label: _requiredLabel("Feeds how many people?"), border: const OutlineInputBorder()),
                        ),
                        const SizedBox(height: 15),
                          ...
                          children: [
                            Expanded(
                              child: DropdownButtonFormField<String>(
                                value: foodCategory,
                                decoration: InputDecoration(label: _requiredLabel("State"), border: const OutlineInputBorder()),
                        ...
                        DropdownButtonFormField<String>(
                          value: prepTime,
                          decoration: InputDecoration(label: _requiredLabel("Prepared when?"), border: const OutlineInputBorder()),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              // STITCHING THE PERFECT ADDRESS TOGETHER
                              String exactBuilding = widget.userData['exactAddress'] ?? '';
                              String exactStreet = widget.userData['streetName'] ?? '';
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: _attemptPostFood, // WIRED TO PROFILE CHECK
        ...
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('donations')
                ...
                .where('status', whereIn: ['Available', 'Accepted', 'Picked Up'])
                .snapshots(),
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  bool isPickedUp = currentStatus == 'Picked Up';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isPickedUp ? Colors.purple.shade100 : (isAccepted ? Colors.blue.shade100 : Colors.green.shade100),
                                  borderRadius: BorderRadius.circular(10),
                                ),
                                child: Text(currentStatus, style: TextStyle(
                                    color: isPickedUp ? Colors.purple.shade800 : (isAccepted ? Colors.blue.shade800 : Colors.green.shade800),
                          ...
                          // --- SHOW SECURE PIN IF VOLUNTEER IS COMING ---
                          if (isAccepted) ...[
                            ...
                            Row(children: [
                              ...
                              Expanded(child: Text("Volunteer ${postData['volunteerName']} is on the way to you!", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)))
                            ]),
                          ],
                          ...
                          if (isPickedUp) ...[
                            const Divider(height: 20),
                            Row(children: [
                              Icon(Icons.local_shipping, size: 18, color: Colors.purple.shade700),
                              const SizedBox(width: 8),
                              Expanded(child: Text("Volunteer ${postData['volunteerName']} has picked up the food!", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.purple.shade700)))
                            ]),
                          ],

                          // Hide cancel button if accepted or picked up
                          if (!isPickedUp && !isAccepted) ...[
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton(
                                onPressed: () async {
                                  await FirebaseFirestore.instance.collection('users').doc(widget.uid).update({'cancellationCount': FieldValue.increment(1)});
